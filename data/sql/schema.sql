...
CREATE TABLE areas_formacion_facilitador (id BIGSERIAL, id_identificacion INT NOT NULL, id_area_formacion INT NOT NULL, estatus SMALLINT DEFAULT 0 NOT NULL, PRIMARY KEY(id));
CREATE TABLE bitacora_formacion_facilitador (id BIGSERIAL, id_area_formacion_facilitador INT NOT NULL, fecha DATE NOT NULL, estatus SMALLINT DEFAULT 0 NOT NULL, PRIMARY KEY(id));
...
CREATE TABLE disponibilidad_dias (id BIGSERIAL, id_identificacion INT NOT NULL, dia SMALLINT NOT NULL, PRIMARY KEY(id));
CREATE TABLE disponibilidad_traslado_estado (id BIGSERIAL, id_identificacion INT NOT NULL, id_estado INT NOT NULL, id_municipio INT NOT NULL, requiere_traslado BOOLEAN DEFAULT 'false' NOT NULL, PRIMARY KEY(id));
...
CREATE TABLE identificacion (id BIGSERIAL, nombre VARCHAR(50) NOT NULL, apellido VARCHAR(50) NOT NULL, cedula_pasaporte VARCHAR(8) NOT NULL UNIQUE, nacionalidad VARCHAR(20) NOT NULL, direccion VARCHAR(100) NOT NULL, sector VARCHAR(100), situacion_laboral VARCHAR(50) NOT NULL, formacion_politica BOOLEAN DEFAULT 'false' NOT NULL, habilitado BOOLEAN DEFAULT 'true' NOT NULL, id_estado INT NOT NULL, id_municipio INT NOT NULL, id_parroquia INT NOT NULL, PRIMARY KEY(id));
...
CREATE TABLE secciones (id BIGSERIAL, id_identificacion INT, id_area_formacion INT NOT NULL, nombre_seccion VARCHAR(50) NOT NULL, id_ente INT NOT NULL, PRIMARY KEY(id));
CREATE TABLE telefonos (id BIGSERIAL, id_identificacion INT NOT NULL, numero VARCHAR(12) NOT NULL, PRIMARY KEY(id));
