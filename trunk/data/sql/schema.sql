...
CREATE TABLE areas_formacion_facilitador (id BIGSERIAL, id_identificacion INT NOT NULL, id_area_formacion INT NOT NULL, estatus SMALLINT NOT NULL, PRIMARY KEY(id));
