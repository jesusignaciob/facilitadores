...
'Crear' : 'Modificar').(!$form->getObject()->isNew() ? '?id='.$form->getObject()->getId() : '')) ?>">
    ...
    <ul class="sf_gmstv_actions">
      ...
      <li class="sf_gmstv_action_delete"><?php echo link_to('Eliminar', 'formacion/areasFormacionEliminar?id='.$form->getObject()->getId(), array('method' => 'delete','confirm' => 'estas seguro?')) ?></li>
      <?php endif; ?>
