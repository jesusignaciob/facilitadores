<!--
Document / Documento: _formSecciones del Módulo Formación para la Vista Secciones
...
'Crear' : 'Modificar').(!$form->getObject()->isNew() ? '?id='.$form->getObject()->getId() : '')) ?>">
    ...
    <ul class="sf_gmstv_actions">
      ...
      <li class="sf_gmstv_action_delete"><?php echo link_to('Eliminar', 'formacion/seccionesEliminar?id='.$form->getObject()->getId(), array('method' => 'delete','confirm' => 'Seguro Desea Eliminar?')) ?></li>
      <?php endif; ?>
